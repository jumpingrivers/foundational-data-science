...
chapter. Instead, the goal of this chapter is to give an intuituve 
feel for some of the standard probability distributions. Even if you have never 
taken a course in statistics, you'll have come the simplest probaility distribution already, 
...
One of the simplest distributions is a Uniform distribution. 
...
Suppose you are using a data centre where the probability of a server failure is 0.001 per day.
