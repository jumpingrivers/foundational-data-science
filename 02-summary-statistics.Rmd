...
<!-- XXX this one is just for me? Why the two different storages here? -->
...
<!-- XXX is it worth a note that average could mean lots of things? -->
...
<!-- XXX but not descending order? -->
<!-- related (kind of) but interesting question -->
<!-- why does the median.default source have the code x[FALSE][NA] rather than just NA? -->
<!-- I think I can guess but wondered if you knew definiteively -->
...
<!-- XXX I don't think the previous is true barplot(table(Beauty$students)) -->
...
As well as knowing the location statistics of a data set, we often also want to know how variable 
...
use
<!-- XXX Whilst I don't necessarily disagree here it seems weird to mention this here since you haven't mentioned numerical stability yet, just feels odd, not saying it should definitely be removed, maybe reworded or better explained -->
\[
...
<!-- XXX The thing that sucks about quantiles of course is that quantile(5:8,0.25) != 5.25 similarly for the upper quartile, i thik type = 6 is the one that gives you "the right" answers , damn seen the note below now-->
