...
MvNormal(2000, c(1.0, 0.8, 0.4, 0.0, -0.4, -0.8, -1.0));
RotNormal(1500, c(0, pi/12, pi/6, pi/4, pi/2-pi/6, pi/2-pi/12, pi/2));
Others(2500)
# sink=dev.off()
# system("pdfcrop ../graphics/basic_f4.pdf")

#dev.copy2pdf(file="correlation.pdf", width=8, height=6)
