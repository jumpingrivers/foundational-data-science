...
# Hereford Mappa Mundi (1300)
  ...
  * It is the largest medieval [map](https://en.wikipedia.org/wiki/Hereford_Mappa_Mundi) known still to exist
    ...
    * At the top is the garden of Eden (some of the data points are approximate!)

```{r, 3-2, echo=FALSE, out.width = "40%"}
...
(g_smooth = g + 
   stat_smooth(colour = "steelblue", se = FALSE, method = "loess"))
```
