...
smaller than 5%. Thus, here we would say:
  ...
  * Our p–value is greater than 5% (in fact, it’s larger tha 10% – a computer
...
our calculation. However, when the sample size is large, the `t.test()` function is equilivent to a z-test.
...
How do we compare the website that uses the Comic Sans font to the blinking site? We use a two sampled t-test! 
